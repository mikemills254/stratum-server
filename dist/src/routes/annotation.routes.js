...
router.patch("/:id", auth_middlware_1.default.verify, (req, res) => controller.handleUpdateAnnotation(req, res));
router.delete("/:id", auth_middlware_1.default.verify, (req, res) => controller.handleDeleteAnnotation(req, res));
